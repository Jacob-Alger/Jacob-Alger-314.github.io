...
![HMI schematic](hmi_subsystem_314-rev2.png){style width:"350" height:"300;"}
**Figure 1:** Human-Machine Interface Schematic.


## Resouces

The schematic as a PDF download is available [*here*](hmi_subsystem_314.pdf), and the Zip folder of the project [*here*](hmi_subsystem_314-rev2.png).
